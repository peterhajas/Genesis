...
{
    NSString* suggestion = [autocompleteSuggestionsForCurrentWord objectAtIndex:[indexPath row]];
    GNTextAutocompleteSuggestionCell* cell = [[GNTextAutocompleteSuggestionCell alloc] initWithText:suggestion];
